...
pub fn sha384(message: &[u8]) -> String {
    const K: [u64; 80] = [
...
mod tests {
    ...
    fn sha384_test() {
        assert_eq!(
            ...
            4edebfe76f65fbd51ad2f14898b95b".to_string(),
            sha384("".as_bytes()),
        );
        assert_eq!(
            "ca737f1014a48f4c0b6dd43cb177b0afd9e5169367544c494011e3317dbf9a509c\
            b1e5dc1e85a941bbee3d7f2afbc9b1".to_string(),
            sha384("The quick brown fox jumps over the lazy dog".as_bytes()),
        );
        assert_eq!(
