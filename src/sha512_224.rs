use crate::sha512_t_iv_generator::sha512_t_iv_generator;
use std::convert::TryInto;

#[allow(non_snake_case)]
pub fn sha512_224(message: &[u8]) -> String {
    const K: [u64; 80] = [
    ...
    let iv = sha512_t_iv_generator("SHA-512/224".as_bytes());
    ...
    let mut digest = [h0, h1, h2, h3, h4, h5, h6, h7]
        .iter()
