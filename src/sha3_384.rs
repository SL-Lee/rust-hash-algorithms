...
impl SHA3_384 {
    ...
    pub fn digest(&self) -> [u8; 48] {
        keccak(832, 768, &self.data, 0x06, 48).unwrap()[..]
            .try_into()
            .unwrap()
    }
...
mod tests {
    ...
    fn sha3_384_test() {
        ...
        assert_eq!(
            ...
            713831264adb47fb6bd1e058d5f004".to_string(),
            hasher.hexdigest(),
        );
        ...
        assert_eq!(
            "7063465e08a93bce31cd89d2e3ca8f602498696e253592ed26f07bf7e703cf3285\
            81e1471a7ba7ab119b1a9ebdf8be41".to_string(),
            hasher.hexdigest(),
        );
